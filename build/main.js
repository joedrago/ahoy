...
(function() {
  var StreamZip, backupTimestamp, dirExists, dircompare, downloadLatestZip, findLatestFileLinks, fs, generateNowString, main, makeFreshDownloadDir, pad, path, puppeteer, rimraf, updateMod, waitForFile, waitMS;
  ...
  updateMod = async function(modName, versionFilter, wowAddonsDir, wowAddonsBackupDir, configFileDir) {
  ...
  main = async function() {
    var args, config, configFileDir, configFilename, configIndex, configs, dstPath, i, j, k, len, len1, len2, mod, modCount, modIndex, rawConfigFilename, ref, syntax;
    syntax = function() {
